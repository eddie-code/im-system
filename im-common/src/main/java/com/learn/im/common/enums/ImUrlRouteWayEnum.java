...
public enum ImUrlRouteWayEnum {
     ...
     * 随机
     */
    RAMDOM(1,"com.learn.im.common.route.algorithm.random.RandomHandle"),


    /**
     * 1.轮训
     */
    LOOP(2,"com.learn.im.common.route.algorithm.loop.LoopHandle"),

    /**
     * HASH
     */
    HASH(3,"com.learn.im.common.route.algorithm.consistenthash.ConsistentHashHandle"),
    ;
